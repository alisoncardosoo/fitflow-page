  ...
  return (
    <section id="top" className="relative isolate flex min-h-[88svh] items-center overflow-hidden pt-28">
      <div className="hero-vignette absolute inset-0 -z-20">
        <Image
          src="/images/fitflow-hero-gym.jpg"
  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      <div className="absolute inset-0 -z-10 opacity-50">
        <Image
          src="/images/fitflow-gym-background.jpg"
  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      <div className="absolute inset-0 -z-10">
        <Image
          src="/images/fitflow-kettlebell.jpg"
      ...
      <div className="section-shell">
        <div className="glass-panel relative overflow-hidden rounded-[36px] p-6 md:p-10 lg:p-12">
          <div className="absolute inset-y-0 right-0 hidden w-1/2 lg:block">
            <Image
              src="/images/fitflow-trainer.jpg"
              alt="Treinador acompanhando aluna"
              fill
              className="object-cover opacity-[0.42]"
              sizes="50vw"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-graphite via-graphite/[0.55] to-transparent" />
          </div>
          <div className="relative z-10 max-w-2xl">
            <p className="mb-5 text-sm font-medium uppercase tracking-[0.22em] text-lime/80">
              Sua academia em fluxo
            </p>
            <h2 className="text-balance text-4xl font-semibold leading-[1.02] text-ice md:text-6xl">
              Coloque sua academia em fluxo.
            </h2>
            <p className="mt-5 text-lg leading-8 text-muted">
              Solicite uma demonstração e veja como o FitFlow pode tornar sua gestão mais clara,
              fluida e profissional.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <PrimaryButton href={WHATSAPP_URL} label="Solicitar demonstração" />
              <a
                className="focus-ring inline-flex min-h-14 items-center justify-center gap-3 rounded-full border border-white/[0.12] bg-white/[0.05] px-7 text-base font-semibold text-ice transition duration-700 ease-smooth hover:bg-white/[0.085]"
                href={WHATSAPP_URL}
                rel="noreferrer"
                target="_blank"
              >
            ...
            <div className="mt-7 inline-flex flex-col gap-2 rounded-[24px] border border-lime/[0.22] bg-lime/[0.08] px-5 py-4 sm:flex-row sm:items-end sm:gap-4">
              <span className="text-sm font-medium text-muted">
                De <span className="text-ice line-through decoration-lime/70">R$ 599,00</span>
              </span>
              <span className="text-3xl font-semibold leading-none text-lime md:text-4xl">
                por R$ 149,00
              </span>
            </div>
          </div>
